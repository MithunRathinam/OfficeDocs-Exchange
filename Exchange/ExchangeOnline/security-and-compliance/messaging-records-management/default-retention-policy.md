...
[NOTE]
The Default MRM Policy doesn't include a default tag for Deleted items folder as per [Extended email retention for deleted items in Office 365](https://www.microsoft.com/en-us/microsoft-365/blog/2015/02/20/extended-email-retention-deleted-items-office-365/). If you want to keep the 30-day retention or set a custom retention period, that can be done by adding a new retention tag for deleted items folder to Default MRM Policy.
